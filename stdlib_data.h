...
static const char stdlib_scm[] =
    ...
    "  (syntax-rules ()\n"
    "    ((let* () body ...)\n"
    "     (let () body ...))  ; Use let for proper scoping of internal "
    "defines\n"
    ...
    "==\n"
    "\n"
    "; filter - return list of elements satisfying predicate (tail-recursive, "
    "in-order)\n"
    ...
    "       field-spec ...)\n"
    "     (begin\n"
    "       ;; Generate a unique type tag (a gensym would be better, but "
    "symbol works)\n"
    ...
    "==\n"
    "\n"
    ";; cut creates a procedure by specializing some parameters of another "
    "procedure.\n"
    ...
    ";; (cut list 1 <> 3 <...>)    => (lambda (x . rest) (apply list 1 x 3 "
    "rest))\n"
    ...
    "     (cut-helper (param ...) (arg ... expr) rest))))\n"
    "\n"
    ";; cute is like cut but evaluates non-slot expressions at definition "
    "time\n"
    ";; (not at call time like cut does).\n"
    ";;\n"
    ";; Example:\n"
    ";; (cute cons (+ a 1) <>) evaluates (+ a 1) once when cute form is "
    "evaluated,\n"
    ...
    "                      (cond\n"
    "                        ((or (char=? directive #\\a) (char=? directive "
    "#\\A))\n"
    "                         (if (null? args)\n"
    "                             (error \"format: not enough arguments for "
    "~a\")\n"
    "                             (begin\n"
    "                               (display (car args) port)\n"
    "                               (loop (+ i 2) (cdr args)))))\n"
    "                        ((or (char=? directive #\\s) (char=? directive "
    "#\\S))\n"
    "                         (if (null? args)\n"
    "                             (error \"format: not enough arguments for "
    "~s\")\n"
    ...
    "                               (write (car args) port)\n"
    "                               (loop (+ i 2) (cdr args)))))\n"
    "                        ((or (char=? directive #\\d) (char=? directive "
    "#\\D))\n"
    "                         (if (null? args)\n"
    "                             (error \"format: not enough arguments for "
    "~d\")\n"
    ...
    "                         (loop (+ i 2) args))\n"
    "                        (else\n"
    "                         (error \"format: unknown directive\" "
    "directive))))\n"
    "                    (error \"format: incomplete escape at end of "
    "string\"))\n"
    "                (begin\n"
    "                  (write-char c port)\n"
    "                  (loop (+ i 1) args))))\n"
